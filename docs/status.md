...
| P19 Real HF N-best Extraction | blocked | HF dataset 확인 완료, RTX 4080 SUPER에서도 large-v3 beam20/return20 CUDA OOM |

## Next Actions

1. P19를 계속하려면 더 큰 GPU, smaller model, beam/return 축소, 또는 runtime 변경 여부를 결정한다.
