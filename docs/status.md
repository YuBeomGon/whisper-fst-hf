...
P10 End-to-End Offline MVP Run을 완료했다.
...
1. P11 Calibration / Rule Tuning을 시작한다.
2. synthetic evaluation 결과로 lambda/margin/rule policy sweep report를 생성한다.
3. final eval 전 freeze 기준과 residual risk를 명시한다.
